const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  body{background:#07080F;font-family:'Cairo',sans-serif;direction:rtl;overflow-x:hidden;-webkit-overflow-scrolling:touch;height:100%;}
  ...
  *{-webkit-overflow-scrolling:touch;}
  ...
  @keyframes splashSlideUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}
  @keyframes splashPulse{0%,100%{opacity:1;transform:scale(1)}50%{opacity:.7;transform:scale(0.97)}}
