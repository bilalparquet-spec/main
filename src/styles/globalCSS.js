const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  @keyframes agencyPulseRing{0%{transform:scale(1);opacity:.7}100%{transform:scale(1.55);opacity:0}}
  @keyframes rotatingSweep{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}
  .agency-btn-glow{position:relative;}
  .agency-btn-glow::before{content:'';position:absolute;inset:-3px;border-radius:17px;background:conic-gradient(from 0deg,transparent 0deg,transparent 60deg,rgba(167,139,250,.9) 120deg,rgba(255,255,255,.95) 150deg,rgba(167,139,250,.9) 180deg,transparent 240deg,transparent 360deg);animation:rotatingSweep 2.4s linear infinite;z-index:-1;}
  .agency-btn-glow::after{content:'';position:absolute;inset:1.5px;border-radius:13px;background:rgba(7,8,15,.92);z-index:-1;}
