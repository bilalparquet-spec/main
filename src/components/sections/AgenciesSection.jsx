...
export function AgenciesSection({ delay }) {
  ...
  return (
    <div style={{ marginBottom:36, animation:`fadeUp .55s ease ${delay}s both` }}>
      ...
      <div ref={ref} {...handlers} style={{
        ...
        {AGENCIES.map((ag, i) => (
          <div key={ag.id} className="btn-press" style={{
            ...
            <div style={{ padding:"11px 13px" }}>
              ...
              <div style={{ fontSize:10, color:"rgba(255,255,255,.38)", marginBottom:8 }}>📍 {ag.wilaya} · {ag.cars} سيارة</div>
