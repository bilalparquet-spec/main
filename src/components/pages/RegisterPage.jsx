    ...
    <div style={{ position: "fixed", inset: 0, background: "#07080F", display: "flex", flexDirection: "column", overflowY: "auto", overscrollBehavior: "contain", animation: "fadeUp .35s ease" }}>
      ...
      <div style={{ position: "relative", height: 200, flexShrink: 0, overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10 }}>
          <div style={{ width: "clamp(60px,15vw,80px)", height: "clamp(60px,15vw,80px)", borderRadius: 20, background: "linear-gradient(135deg,#6D28D9,#4F46E5)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 32px rgba(109,40,217,.55)" }}>
            <img src={LOGO_IMG} alt="logo" style={{ width: "72%", height: "72%", objectFit: "contain" }}/>
          </div>
          <span style={{ fontWeight: 900, fontSize: "clamp(16px,4.5vw,22px)", background: "linear-gradient(90deg,#A78BFA,#818CF8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "-.5px" }}>Rent&درايف</span>
        </div>
      </div>
