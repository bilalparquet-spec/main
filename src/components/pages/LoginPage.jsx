...
import { GoogleBtn } from "../GuestAuthSheet.jsx";

export function LoginPage({ onBack, onGoRegister }) {
  ...
  return (
    <div style={{
      ...
      {/* ── Form ── */}
      <div style={{ flex: 1, padding: "28px 24px 40px", maxWidth: 480, width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
        <h1 style={{
