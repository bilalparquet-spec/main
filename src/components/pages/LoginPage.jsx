    ...
    <div style={{
      ...
      <div style={{ position: "relative", height: "clamp(180px,35vw,260px)", flexShrink: 0, overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10 }}>
          <div style={{ width: "clamp(64px,16vw,88px)", height: "clamp(64px,16vw,88px)", borderRadius: 22, background: "linear-gradient(135deg,#6D28D9,#4F46E5)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 32px rgba(109,40,217,.55)" }}>
            <img src={LOGO_IMG} alt="logo" style={{ width: "72%", height: "72%", objectFit: "contain" }}/>
          </div>
          <span style={{ fontWeight: 900, fontSize: "clamp(18px,5vw,24px)", background: "linear-gradient(90deg,#A78BFA,#818CF8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "-.5px" }}>Rent&درايف</span>
        </div>
      </div>
      ...
      <div style={{ flex: 1, padding: "28px 24px 40px", maxWidth: "clamp(320px,92vw,520px)", width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
        ...
        <button onClick={onGoRegister} style={{ width: "100%", padding: "14px 20px", borderRadius: 16, border: "1.5px solid rgba(167,139,250,.3)", background: "rgba(109,40,217,.08)", color: "#A78BFA", fontSize: 14, fontWeight: 800, fontFamily: "inherit", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "background .2s" }}
