  ...
  return (
    ...
    >
      ...
      <div style={{flex:"0 0 42%", display:"flex", alignItems:"center", justifyContent:"center", position:"relative"}}>
        ...
        <div style={{
          width:"clamp(85px,22vw,120px)", height:"clamp(85px,22vw,120px)", borderRadius:"clamp(20px,5vw,30px)",
          ...
          <div style={{position:"absolute",inset:0,borderRadius:"clamp(20px,5vw,30px)",background:"linear-gradient(135deg,rgba(255,255,255,.18) 0%,transparent 60%)"}} />
      ...
      <div style={{
        ...
        borderBottom:"none",
        padding:"clamp(18px,5vw,30px) clamp(16px,5vw,28px) clamp(14px,4vw,22px)",
        display:"flex", flexDirection:"column",
        overflow:"hidden",
      }}>
        <div style={{
          ...
          <div style={{marginBottom:14}}>
            <div style={{fontSize:"clamp(16px,5vw,22px)",fontWeight:800,color:"rgba(255,255,255,.75)",lineHeight:1.2}}>{sl.title1}</div>
            <div style={{
              fontSize:"clamp(28px,8vw,38px)", fontWeight:900, lineHeight:1.1, letterSpacing:"-1.5px",
              background:`linear-gradient(90deg,${sl.light},#fff)`,
              WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent",
            }}>{sl.title2}</div>
          </div>

          <div style={{fontSize:"clamp(12px,3.2vw,14px)",color:"rgba(255,255,255,.48)",lineHeight:1.9,marginBottom:18}}>
            <div>{sl.sub1}</div>
            <div>{sl.sub2}</div>
          </div>
