...
Object.assign(UI.en, {
  ...
  "ليلة لا تُنسى تستحق السيارة المثالية": "An unforgettable night deserves the perfect car",
  ...
  "الوكالات الموثقة فقط": "Verified agencies only",
  "السعر اليومي (دج)": "Daily price (DZD)",
...
UI.tz = {
  ...(UI.ar || {}),
  "تجربة قيادة استثنائية": "ⵜⵊⵔⴱⵜ ⵏ ⵜⵓⵏⵀⴰⵢⵜ",
  "اختيار عملي للعائلات والرحلات الجماعية": "ⴰⵅⵜⵢⴰⵔ ⴰⵏⴰⴼⴰⴷ ⵉ ⵜⵡⴰⵛⵓⵍⵉⵏ ⴷ ⵉⵔⵃⵍⴰⵏ ⵏ ⵓⴳⵔⵓⴱ",
  "كهربائي": "ⴽⴰⵀⵔⴰⴱⴰⵢ",
  "كهربائية": "ⴽⴰⵀⵔⴰⴱⴰⵢⵜ",
  "علبة الرسائل": "ⵜⴰⵏⴽⵔⴰ ⵏ ⵉⵣⵏⴰⵏ",
  "الرسائل": "ⵉⵣⵏⴰⵏ",
  "الإشعارات": "ⵉⵙⵖⴰⵡⴰⵙⵏ",
  "نشاط": "ⴰⵏⴰⵔⵎⵓ"
};
