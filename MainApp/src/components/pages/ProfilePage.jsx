...
export function ProfilePage({ onLogout }) {
  ...
  if (pathname === "/profile/account/notifications" || pathname === "/profile/account/transmission") {
    const title = pathname.endsWith("/notifications") ? (t.notificationsPage || t.notificationSettings) : (t.transmissionPage || t.transmission);
    return (
      <div dir={dir} style={base}>
